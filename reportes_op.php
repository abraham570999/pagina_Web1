 ...
 ?>
   ...
   <section id="about" class="about">
      ...
      <div class="row">
        ...
        <form action="controlador_op.php" method="post" class="jumbotron" enctype="multipart/form-data">
...
<?php if (isset($_GET['id_modificar3'])) {
 ?>
   ...
   <section id="about" class="about">
      ...
      <div class="row">
        <!--BUSQUEDAS POR SELECT-->
        <form action="controlador:op.php" method="post" class="jumbotron" enctype="multipart/form-data">
<input type="text" hidden="" id="txtid" name="txtid" value="<?php echo @$reporte_modificar[0]['id_reporte']; ?>">
            <!--Caja de texto para calle-->
...
<h3>Sin Registrar</h3>
   ...
   <form action="controlador_op.php#formulariobusqueda"  method="post">
      <br>
      <div class="row">
...
?>" height="100" width="100"></td>
         ...
         <td>
            <a class="btn btn-danger" href="controlador_op.php?id_update=<?php echo $renglon['id_reporte']; ?>" onclick="return ConfirmCambio()">Registrado</a></td>  
          <?php 
                                      if (@$_SESSION['privilegio'] == 'Admin') 
                                      {
            ...
            <a class="btn btn-primary" id="btnmodificar" href="controlador_op.php?id_modificar2=<?php echo $renglon['id_reporte']; ?>" onclick="return ConfirmEdit()">Modificar</a></td>
          <?php } ?>
           <?php 
                                      if (@$_SESSION['privilegio'] == 'AdminAlterns') 
                                      {
            ...
            <a class="btn btn-primary" id="btnmodificar" href="controlador_op.php?id_modificar3=<?php echo $renglon['id_reporte']; ?>" onclick="return ConfirmEdit()">Modificar</a></td>
          <?php } ?>
            <?php 
                                      if (@$_SESSION['privilegio'] == 'Admin') 
                                      {
                                  ...
                                  ?> <td>
            <a class="btn btn-info" id="btneliminar" href="controlador_op.php?id_eliminar=<?php echo $renglon['id_reporte']; ?>" onclick="return ConfirmDelete()" >Eliminar</a></td>
          <?php } ?>
             <?php 
                  if (@$_SESSION['privilegio'] == 'Admin')                   
                     ?> <td>
...
?>" height="100" width="100"></td>
         ...
         <td>
            <a class="btn btn-danger" href="controlador_op.php?id_update2=<?php echo $renglon['id_reporte']; ?>" onclick="return ConfirmCambio()">Arreglado</a></td>
