...
<head>
  ...
  <title>VERIFICACION DE REPORTES</title>
...
<script type="text/javascript">
  function Confirm()
  {
    var respuesta =confirm("¿Estas seguro que desea enviar el reporte a este Departamento?");
    if (respuesta ==true)
    {
      return true;
...
<!-- ======= Hero Section ======= -->
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          <h1>FILTRO DE LOS DIVERSOS <span>REPORTES</span>.</h1>
          <h2></h2>
  ...
  <main id="main">
   ...
   <form action="controlador_filtro.php"  method="post">
      <br>
      <div class="row">
...
<option>Fallas electricas</option>
      ...
      <table class="table table-dark table-striped" style="display: block; overflow: auto;">
        <tr>
          ...
          <td>Nota</td>
          <td>Imagen</td>
          <td colspan="3" align="center">Enviar a:</td>
          <td align="center">Acción</td>
            
            
        </tr>
        <?php foreach ($listado3 as $renglon) { ?>
        <tr>
          <td>
          ...
          <td>
            <img src="<?php if(isset($renglon['Imagen']))
              ...
              <td><a class="btn btn-info" href="controlador_filtro.php?id_enviar=<?php echo $renglon['id_reporte']; ?>" onclick="return Confirm()">Obras Públicas</a></td>
               <td><a class="btn btn-info" href="controlador_filtro.php?id_enviar1=<?php echo $renglon['id_reporte']; ?>" onclick="return Confirm()">Simas</a></td>
               <td><a class="btn btn-info" href="controlador_filtro.php?id_enviar2=<?php echo $renglon['id_reporte']; ?>" onclick="return Confirm()">Ambos Departamentos</a></td>
               <td>
            <a class="btn btn-danger" id="btneliminar" href="controlador_filtro.php?id_eliminar=<?php echo $renglon['id_reporte']; ?>" onclick="return ConfirmDelete()" >Eliminar</a></td>
        </tr>
      <?php } ?>
