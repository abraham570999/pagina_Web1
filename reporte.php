 ...
 ?>
   ...
   <section id="about" class="about">
      ...
      <div class="row">
        ...
        <form action="controlador.php" method="post" class="jumbotron" enctype="multipart/form-data">
...
?>" height="100" width="100"></td>
                 <?php 
                                  ...
                                  ?> 
         <td>
            <a class="btn btn-danger" href="controlador.php?id_update=<?php echo $renglon['id_reporte']; ?>" onclick="return ConfirmCambio()">Registrado</a></td>  <?php } ?> 
          <?php 
                                      if (@$_SESSION['privilegio'] == 'Admin') 
                                      {
          ...
          <?php } ?>
           <?php 
            ...
            <a class="btn btn-primary" id="btnmodificar" href="controlador.php?id_modificar3=<?php echo $renglon['id_reporte']; ?>" onclick="return ConfirmEdit()">Modificar</a></td>
          <?php } ?>
            <?php 
                                      if (@$_SESSION['privilegio'] == 'Admin') 
                                      {
                                  ...
                                  ?> <td>
            <a class="btn btn-info" id="btneliminar" href="controlador.php?id_eliminar=<?php echo $renglon['id_reporte']; ?>" onclick="return ConfirmDelete()" >Eliminar</a></td>
          <?php } ?>
        </tr>
      <?php } ?>
      </table>
